...
const Main = () => <div className="relative flex-1">{/* Your content */}</div>;
...
const LoadingText = () => (
  <div className="mr-20 text-gray-400">{/* Your content */}</div>
);

export const Stage: React.FC = () => {
  const { initializeVideoPlayer, preview } = VideoCreatorStore();
  return (
