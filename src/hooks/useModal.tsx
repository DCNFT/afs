...
import { Handler } from '@/components/modalMigration/types';
...
const useModal = (
  ...
  const onPresentCallback = useCallback(() => {
    presentModal(currentModal.current, modalId, closeOnOverlayClick);
  }, [modalId, presentModal, closeOnOverlayClick]);

  const onDismissCallback = useCallback(() => {
    if (nodeId === modalId) {
      dismissModal?.();
    }
  }, [modalId, dismissModal, nodeId]);
